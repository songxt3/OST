...
def parse_args():
    ...
    parser.add_argument('--dataset', default='dvs10gesture', help='dataset')
...
def load_data(dataset_dir, distributed, T):
    ...
    # origin_set = dvs128_gesture.DVS128Gesture(root=dataset_dir, train=True, data_type='frame', frames_number=T, split_by='number')
    # dataset_train, dataset_test = split_to_train_test_set(0.9, origin_set, 11)

    dataset_train = dvs128_gesture.DVS128Gesture(dataset_dir, train=True, data_type='frame', split_by='number', frames_number=T)
    dataset_test = dvs128_gesture.DVS128Gesture(dataset_dir, train=False, data_type='frame', split_by='number', frames_number=T)
