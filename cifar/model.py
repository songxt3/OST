...
class SPS(nn.Module):
    def __init__(self, img_size_h=128, img_size_w=128, patch_size=4, in_channels=2, embed_dims=256):
        ...
        self.down_sample_conv1 = nn.Conv2d(embed_dims//2, embed_dims//2, kernel_size=3, stride=2, padding=1, bias=False)
        self.down_sample_bn1 = nn.BatchNorm2d(embed_dims//2)
        ...
        self.down_sample_conv2 = nn.Conv2d(embed_dims, embed_dims, kernel_size=3, stride=2, padding=1, bias=False)
        self.down_sample_bn2 = nn.BatchNorm2d(embed_dims)
    ...
    def forward(self, x):
        ...
        x = self.down_sample_bn1(x).reshape(T, B, -1, H//2, W//2).contiguous()
        ...
        x = self.down_sample_bn2(x).reshape(T, B, -1, H//4, W//4).contiguous()
